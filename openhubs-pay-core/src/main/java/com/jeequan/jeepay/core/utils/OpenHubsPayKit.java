 ...
 */
package com.openhubs.pay.core.utils;
...
*/
@Slf4j
public class OpenHubsPayKit {

    public static byte[] AES_KEY = "4ChT08phkz59hquD795X7w==".getBytes();

    /** 加密 **/
    public static String aesEncode(String str){
        return SecureUtil.aes(OpenHubsPayKit.AES_KEY).encryptHex(str);
    }

    public static String aesDecode(String str){
        return SecureUtil.aes(OpenHubsPayKit.AES_KEY).decryptStr(str);
    }
