...
public class MainGen {
    ...
    public static final String THIS_MODULE_NAME = "openhubs-pay-z-codegen"; //当前项目名称

    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/openhubs_pay?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT%2B8";
    ...
    public static void main(String[] args) {
        ...
        pc.setParent("com.openhubs.pay");  //根目录
