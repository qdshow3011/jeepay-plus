...
import com.openhubs.pay.components.mq.model.PayOrderMchNotifyMQ;
import com.openhubs.pay.components.mq.vender.IMQSender;
import com.openhubs.pay.core.entity.MchNotifyRecord;
...
import com.openhubs.pay.pay.rqrs.refund.QueryRefundOrderRS;
import com.openhubs.pay.pay.rqrs.transfer.QueryTransferOrderRS;
import com.openhubs.pay.service.impl.MchNotifyRecordService;
...
public class PayMchNotifyService {
    ...
    public String createNotifyUrl(PayOrder payOrder, String appSecret) {
        ...
        // 报文签名
        jsonObject.put("sign", OpenHubsPayKit.getSign(jsonObject, appSecret));
    ...
    public String createReturnUrl(PayOrder payOrder, String appSecret) {
        ...
        // 报文签名
        jsonObject.put("sign", OpenHubsPayKit.getSign(jsonObject, appSecret));   // 签名
