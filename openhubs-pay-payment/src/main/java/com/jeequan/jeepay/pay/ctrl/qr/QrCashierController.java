 ...
 */
package com.openhubs.pay.pay.ctrl.qr;
...
import com.openhubs.pay.pay.channel.IChannelUserService;
...
public class QrCashierController extends AbstractPayOrderController {
    ...
    private PayOrder getPayOrder(){
        ...
        String payOrderId = OpenHubsPayKit.aesDecode(getToken()); //解析token
