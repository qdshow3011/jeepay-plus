 ...
 */
package com.openhubs.pay.pay.model;

import com.alipay.api.*;
import com.openhubs.pay.core.constants.CS;
import com.openhubs.pay.core.model.params.alipay.AlipayConfig;
import com.openhubs.pay.core.model.params.alipay.AlipayIsvParams;
import com.openhubs.pay.core.model.params.alipay.AlipayNormalMchParams;
import com.openhubs.pay.core.utils.SpringBeansUtil;
import com.openhubs.pay.pay.exception.ChannelException;
...
public class AlipayClientWrapper {
    ...
    public static AlipayClientWrapper buildAlipayClientWrapper(Byte useCert, Byte sandbox, String appId, String privateKey, String alipayPublicKey, String signType, String appCert,
        ...
        if(useCert != null && useCert == CS.YES){ //证书的方式
            ...
            certAlipayRequest.setServerUrl(sandbox == CS.YES ? com.openhubs.pay.core.model.params.alipay.AlipayConfig.SANDBOX_SERVER_URL : com.openhubs.pay.core.model.params.alipay.AlipayConfig.PROD_SERVER_URL);
            certAlipayRequest.setAppId(appId);
            certAlipayRequest.setPrivateKey(privateKey);
            certAlipayRequest.setFormat(com.openhubs.pay.core.model.params.alipay.AlipayConfig.FORMAT);
            certAlipayRequest.setCharset(com.openhubs.pay.core.model.params.alipay.AlipayConfig.CHARSET);
            ...
            alipayClient = new DefaultAlipayClient(sandbox == CS.YES ? com.openhubs.pay.core.model.params.alipay.AlipayConfig.SANDBOX_SERVER_URL : com.openhubs.pay.core.model.params.alipay.AlipayConfig.PROD_SERVER_URL
                    , appId, privateKey, com.openhubs.pay.core.model.params.alipay.AlipayConfig.FORMAT, AlipayConfig.CHARSET,
