...
商户业务系统通过统一退款接口发起退款请求，OpenHubs Pay支付网关会根据商户发起的支付订单号，找到对应到支付通道发起退款。

> 接口说明

适用对象：`普通商户` `特约商户`

请求URL：https://pay.OpenHubs Pay.vip/api/refund/refundOrder
...
异步通知地址 | notifyUrl | 否 | String(128) | https://www.openhubs.com/notify.htm | 退款完成后回调该URL,只有传了该值才会发起回调  
...
请求URL：https://pay.OpenHubs Pay.vip/api/refund/query
