 ...
 */
package com.openhubs.pay.service.impl;
...
import com.openhubs.pay.service.mapper.SysUserMapper;
...
//        if(roleIdList.isEmpty()) throw new BizException("请选择角色信息！");
        ...
        if(sysUser.getSex() != null && CS.SEX_FEMALE == sysUser.getSex()){
            sysUser.setAvatarUrl("https://openhubspay.oss-cn-beijing.aliyuncs.com/openhubs-pay/img/defava_f.png");
        }else{
            sysUser.setAvatarUrl("https://openhubspay.oss-cn-beijing.aliyuncs.com/openhubs-pay/img/defava_m.png");
        }
