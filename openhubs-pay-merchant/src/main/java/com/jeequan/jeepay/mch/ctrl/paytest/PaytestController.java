 ...
 */
package com.openhubs.pay.mch.ctrl.paytest;
...
public class PaytestController extends CommonCtrl {
    ...
    public ApiRes doPay() {
        ...
        OpenHubsPayClient openHubsPayClient = new OpenHubsPayClient(dbApplicationConfig.getPaySiteUrl(), mchApp.getAppSecret());

        try {
            PayOrderCreateResponse response = openHubsPayClient.execute(request);
