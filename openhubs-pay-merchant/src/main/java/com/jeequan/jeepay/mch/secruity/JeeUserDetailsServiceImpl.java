 ...
 */
package com.openhubs.pay.mch.secruity;

import com.openhubs.pay.core.constants.CS;
import com.openhubs.pay.core.entity.SysUser;
import com.openhubs.pay.core.entity.SysUserAuth;
...
import com.openhubs.pay.core.utils.RegKit;
...
public class JeeUserDetailsServiceImpl implements UserDetailsService {
    ...
    public UserDetails loadUserByUsername(String loginUsernameStr) throws UsernameNotFoundException {
        ...
        if(auth == null){ //没有该用户信息
            throw OpenHubsPayAuthenticationException.build("用户名/密码错误！");
        }
        ...
        if(CS.PUB_USABLE != sysUser.getState()){ //状态不合法
            throw OpenHubsPayAuthenticationException.build("用户状态不可登录，请联系管理员！");
        }
