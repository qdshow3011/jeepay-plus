...
import com.openhubs.pay.mch.websocket.server.WsPayOrderServer;
import com.openhubs.pay.service.impl.MchAppService;
import com.openhubs.pay.util.OpenHubsPayKit;
...
public class PaytestNotifyController extends CommonCtrl {
    ...
    public void payOrderNotify() throws IOException {
        ...
        params.remove("sign");
        if(!OpenHubsPayKit.getSign(params, mchApp.getAppSecret()).equalsIgnoreCase(sign)){
