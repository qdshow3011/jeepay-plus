 ...
 */
package com.openhubs.pay.mch.ctrl.transfer;
...
import com.openhubs.pay.core.entity.PayInterfaceConfig;
import com.openhubs.pay.core.entity.PayInterfaceDefine;
import com.openhubs.pay.core.exception.BizException;
import com.openhubs.pay.core.model.ApiRes;
import com.openhubs.pay.core.model.DBApplicationConfig;
import com.openhubs.pay.core.utils.OpenHubsPayKit;
import com.openhubs.pay.core.utils.StringKit;
import com.openhubs.pay.exception.OpenHubsPayException;
import com.openhubs.pay.mch.ctrl.CommonCtrl;
import com.openhubs.pay.model.TransferOrderCreateReqModel;
import com.openhubs.pay.request.TransferOrderCreateRequest;
import com.openhubs.pay.response.TransferOrderCreateResponse;
import com.openhubs.pay.service.impl.MchAppService;
import com.openhubs.pay.service.impl.PayInterfaceConfigService;
import com.openhubs.pay.service.impl.PayInterfaceDefineService;
...
public class MchTransferController extends CommonCtrl {
    ...
    public ApiRes channelUserId() {
        ...
        param.put("sign", OpenHubsPayKit.getSign(param, mchApp.getAppSecret()));
    ...
    public ApiRes doTransfer() {
        ...
        OpenHubsPayClient openHubsPayClient = new OpenHubsPayClient(sysConfigService.getDBApplicationConfig().getPaySiteUrl(), mchApp.getAppSecret());

        try {
            TransferOrderCreateResponse response = openHubsPayClient.execute(request);
