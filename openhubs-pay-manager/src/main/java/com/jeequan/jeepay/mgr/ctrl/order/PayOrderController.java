 ...
 */
package com.openhubs.pay.mgr.ctrl.order;
...
import com.openhubs.pay.core.utils.SeqKit;
import com.openhubs.pay.exception.OpenHubsPayException;
import com.openhubs.pay.mgr.ctrl.CommonCtrl;
import com.openhubs.pay.model.RefundOrderCreateReqModel;
import com.openhubs.pay.request.RefundOrderCreateRequest;
import com.openhubs.pay.response.RefundOrderCreateResponse;
...
public class PayOrderController extends CommonCtrl {
    ...
    public ApiRes refund(@PathVariable("payOrderId") String payOrderId) {
        ...
        try {
            RefundOrderCreateResponse response = openHubsPayClient.execute(request);
