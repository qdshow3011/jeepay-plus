...
const routes = [
  { path: '/hub/:openHubsPayToken', name: 'Hub', component: () => import('../views/Hub.vue') },
  { path: '/error', name: 'Error', component: () => import('../views/Error.vue') },
  { path: '/oauth2Callback/:openHubsPayToken', name: 'Oauth2Callback', component: () => import('../views/Oauth2Callback.vue') },
  {
    path: '/cashier',
    name: 'Cashier',
