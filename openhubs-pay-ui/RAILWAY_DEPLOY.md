...
# 运行测试
docker run -d -p 8080:80 -e BACKEND_HOST=your-backend-host OpenHubs Pay-ui-manager:latest
...
```
OpenHubs Pay-ui/
├── OpenHubs Pay-ui-cashier/   # 聚合码收银台
├── OpenHubs Pay-ui-manager/   # 运营平台
├── OpenHubs Pay-ui-merchant/  # 商户系统
