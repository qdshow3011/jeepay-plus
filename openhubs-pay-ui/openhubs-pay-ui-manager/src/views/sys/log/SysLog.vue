      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline" class="table-head-ground">
          <div class="table-layer">
            ...
            <open-hubs-pay-text-up :placeholder="'用户ID'" v-model:value="vdata.searchData.userId" />
            <open-hubs-pay-text-up :placeholder="'用户名'" v-model:value="vdata.searchData.userName" />
            <a-select
...
// import OpenHubsPayTableColumns from '@/components/OpenHubsPayTable/OpenHubsPayTableColumns.vue'
