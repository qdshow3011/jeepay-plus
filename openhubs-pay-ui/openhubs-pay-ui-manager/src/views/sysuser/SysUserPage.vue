      ...
      <div v-if="$access('ENT_UR_USER_SEARCH')" class="table-page-search-wrapper">
        <a-form layout="inline" class="table-head-ground">
          <div class="table-layer">
            <open-hubs-pay-text-up :placeholder="'用户ID'" v-model:value="vdata.searchData.sysUserId" />
            <open-hubs-pay-text-up :placeholder="'用户姓名'" v-model:value="vdata.searchData.realname" />
