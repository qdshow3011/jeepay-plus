...
import openHubsPayStorageWrapper from '@/utils/openHubsPayStorageWrapper'
...
export const useUserStore = defineStore('user', {
  ...
  actions: {
    putToken(token: string) {
      openHubsPayStorageWrapper.setToken(token, true)
    },
    ...
    logout: () => {
      openHubsPayStorageWrapper.cleanToken()
