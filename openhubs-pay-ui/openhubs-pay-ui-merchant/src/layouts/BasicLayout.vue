    ...
    <template #menuHeaderRender>
      <router-link :to="{ path: '/' }" style="display: flex; align-items: center">
        <div v-if="!proLayoutObject.collapsed">
          ...
          <img
            src="@/assets/svg/OpenHubs Pay.svg"
            alt="OpenHubs Pay"
    ...
    <template #headerContentRender>
      ...
      >
        ...
        <div style="display: flex; align-items: center">
          <a-button @click="openUrl('https://www.openhubs.com/ifstore/list.html')">
            接口市场
          </a-button>
          <a-button
            @click="openUrl('https://www.openhubs.com/product/OpenHubs Pay4plus.html')"
            style="margin: 0 10px"
          >
            Plus商业版
          </a-button>
