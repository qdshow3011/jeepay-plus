      ...
      <div class="table-page-search-wrapper">
        <a-form layout="inline" class="table-head-ground">
          <div class="table-layer">
            ...
            />
            <!--            <open-hubs-pay-text-up :placeholder="'转账订单号'" :msg="searchData.transferId" v-model:value="searchData.transferId" />-->
            <!--            <open-hubs-pay-text-up :placeholder="'商户订单号'" :msg="searchData.mchOrderNo" v-model:value="searchData.mchOrderNo" />-->
            <!--            <open-hubs-pay-text-up :placeholder="'渠道支付订单号'" :msg="searchData.channelOrderNo" v-model:value="searchData.channelOrderNo" />-->
...
const infoTable = ref()
const transferOrderDetailRef = ref()
...
function detailFunc(recordId) {
  console.log(transferOrderDetailRef.value)
  transferOrderDetailRef.value.show(recordId)
}
