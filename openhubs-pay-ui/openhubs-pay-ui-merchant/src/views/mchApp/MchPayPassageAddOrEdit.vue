    ...
    <div v-else>
      <a-row :gutter="[24, 24]" style="width: 100%">
        <a-col
          ...
          :key="key"
          :xxl="24 / vdata.openHubsPayCard.span.xxl"
          :xl="24 / vdata.openHubsPayCard.span.xl"
          :lg="24 / vdata.openHubsPayCard.span.lg"
          :md="24 / vdata.openHubsPayCard.span.md"
          :sm="24 / vdata.openHubsPayCard.span.sm"
          :xs="24 / vdata.openHubsPayCard.span.xs"
        >
          <div :style="{ height: vdata.openHubsPayCard.height + 'px' }" class="open-hubs-pay-card-content">
            ...
            <div
              ...
              :style="{
                ...
                height: (vdata.openHubsPayCard.height - 50) / 2 + 'px',
              }"
            >
              <img
                v-if="record.icon"
                :src="record.icon"
                :style="{ height: (vdata.openHubsPayCard.height - 50) / 5 + 'px' }"
              />
            </div>
            <div
              class="open-hubs-pay-card-content-body"
              :style="{ height: (vdata.openHubsPayCard.height - 50) / 2 + 'px' }"
            >
              <div
                class="title"
                :style="{
                  height: (vdata.openHubsPayCard.height - 50) / 4 + 'px',
                  lineHeight: (vdata.openHubsPayCard.height - 50) / 4 + 'px',
                }"
              >
                {{ record.ifName }}
              </div>
