...
<template>
  <a-layout style="overflow: hidden; height: 100vh">
    ...
    <!-- 右侧内容展示区 -->
    <a-layout :style="{ padding: 0, position: 'relative' }">
      <!-- 顶部功能区 -->
      ...
      >
        ...
        <div class="foot">
          Copyright © 2021-2026
          <a href="https://www.openhubs.com" target="_blank">计全科技</a>
          All rights reserved.
        </div>
      </a-layout-content>
    </a-layout>
...
vdata.visible = vdata.broken && !vdata.collapsed
...
const handleResize = debounce(() => {
  ...
  vdata.visible = !vdata.collapsed && window.innerWidth <= 992
}, 50)
